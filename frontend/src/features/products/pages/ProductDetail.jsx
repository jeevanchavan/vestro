            ...
            {loading ? (
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className="flex items-center gap-2 text-[10px] uppercase tracking-[0.2em] text-[#B5ADA3]">
                  ...
                  <span>/</span>
                  <span className="text-[#7A6E63] font-medium truncate max-w-50 sm:max-w-xs">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
                  ...
                  <div className="lg:col-span-6 flex flex-col gap-4 items-center lg:items-start w-full">
                    ...
                    <div className="relative w-full max-w-130 aspect-4/5 max-h-155 bg-[#eae8e5] border border-[#e4e2df] overflow-hidden group">
                      <img
                        src={activeImage}
                    ...
                    <div className="w-full max-w-130 flex items-center justify-between gap-2 pt-1">
                      {/* Previous Button */}
                      <button
                        onClick={handlePrevImage}
                        className="w-8 h-8 flex items-center justify-center text-xs border border-[#e4e2df] text-[#1b1c1a] bg-white/60 hover:bg-[#1b1c1a] hover:text-[#fbf9f6] transition-colors cursor-pointer shrink-0"
                      ...
                      <div className="flex items-center gap-2.5 overflow-x-auto py-1 px-1 no-scrollbar justify-center w-full">
                        {imagesList.map((imgUrl, idx) => (
                          <button
                            ...
                            className={`relative aspect-square w-16 h-16 shrink-0 overflow-hidden border transition-all duration-200 cursor-pointer bg-[#eae8e5] ${selectedImageIndex === idx
                      ...
                      <div className="flex items-center gap-2.5">
                        {['S', 'M', 'L', 'XL'].map((size) => (
                          <button
                            ...
                            className={`w-11 h-11 text-xs font-medium uppercase transition-all duration-200 cursor-pointer flex items-center justify-center border ${selectedSize === size
